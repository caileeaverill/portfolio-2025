...
export const Timeline = ({ data }: { data: TimelineEntry[] }) => {
  ...
  return (
    ...
    >
      ...
      <div ref={ref} className="relative max-w-7xl mb-30 pb-4 mx-auto ">
        {data.map((item, index) => (
          <div
            key={index}
          ...
          >
            <div className="sticky flex flex-col md:flex-row z-40 items-center top-40 self-start max-w-xs lg:max-w-sm md:w-full">
              ...
              <h3 className="hidden md:block text-xl md:pl-20 md:text-5xl font-bold text-neutral-20 ">
                {item.title}
              </h3>
            </div>
        ...
        >
          <motion.div
            ...
            className="absolute inset-x-0 top-0 w-[2px] bg-gradient-to-t from-purple-500 via-pink-500 to-transparent from-[0%] via-[40%] rounded-full"
